...
// Map du niveau (JSON)
let slug = location.href.match(/([^\/]*)\/*$/)[1];
let data = get('/getLevel/' + slug)
  .then(data => {
...
// Ajout des sous-containers dans le container global
    ...
    PIXI.loader
      ...
      .load((loader, resources) => {
        ...
        let grid = new IsoGrid(10, 14, 64, 32, stage, map);
        ...
        wool.x = tiles[map.player.goalTileId].infos.x;
        wool.y = tiles[map.player.goalTileId].infos.y;
